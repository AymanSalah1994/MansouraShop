...
<body class="">
    ...
    <script src="{{ asset('dashboard_assets/js/core/bootstrap-material-design.min.js')}}">
    </script>
    <script src="{{ asset('dashboard_assets/js/plugins/perfect-scrollbar.jquery.min.js')}}">
    </script>
